...
export default function McpApproval({ item, onRespond }: Props) {
  ...
  return (
    <div className="flex flex-col">
      <div className="flex">
        <div className="mr-4 rounded-[16px] p-4 md:mr-24 text-fg bg-surface-2 font-light border border-subtle">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              className="bg-surface-1 text-muted-fg hover:text-fg border border-subtle"
            >
              Decline
            </Button>
          </div>
